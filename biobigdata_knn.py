...
for i in range(2,11,2):
    ...
    # y_fake_test = y_test.values - 1
    # fpr, tpr, thresholds = roc_curve(y_fake_test, knn.predict_proba(X_test)[:, 1])
    ...
    # plt.show()
    # rand_score = roc_auc_score(y_fake_test, knn.predict_proba(X_test)[:, 1])
    # print("n_neighbors = " ,i,"auc :\n",rand_score)
